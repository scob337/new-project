      ...
      <div className="flex flex-wrap justify-center gap-6 w-[100%] ">
        {iconList.map((item, index) => {
          ...
          return (
            <div
              key={index}
              className="group bg-white hover:bg-[#9188F1] cursor-pointer shadow-lg w-[270px] h-[200px] flex flex-col justify-center items-center gap-1 p-3 rounded-lg border border-gray-200 transition-transform duration-300 hover:scale-105"
            >
