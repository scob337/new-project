...
export default function CardWithImg({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center w-[180px] md:w-[220px] lg:w-[293px] h-[40px] md:h-[50px] lg:h-[60px] gap-1">
        <div
        ...
        <div
          style={{ backgroundColor: bgColor, color: Color }}
          className="text-black  w-[130px] md:w-[170px] lg:w-[227px] h-[40px] md:h-[50px] lg:h-[55px] flex items-center px-2 md:px-3 lg:px-6 rounded-[30px] shadow-md transform"
        >
          <p className="w-full h-[20px] md:h-[25px] lg:h-[25px] text-[14px] md:text-[16px] lg:text-[17px]  font-[600] whitespace-nowrap overflow-hidden m-auto">
            {title}
          </p>
        </div>
      </div>
